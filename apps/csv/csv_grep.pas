...
procedure InitArgvParser();
   begin
      ...
      InsertUsage( '');
      InsertUsage( 'Usage:');
      InsertUsage( '   csv_grep [-h <header1,header2,...>] [-f <input file name>] [-o <output file name>] <regular expression>');
      InsertUsage( '');
      InsertUsage( '   ========== Program Options ==========');
      InsertParam( ['h','header'], true, '', 'The comma separated list of header fields to be searched'); 
